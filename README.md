...
Request line, header and Body are the three different parts of an HTTP request
Which part of an HTTP request is optional?
The body portion of the HTTP request is optional.
...
GET and POST methods are the two most common.
...
Body is where the browser receives the web code to style a web page.
Using curl
